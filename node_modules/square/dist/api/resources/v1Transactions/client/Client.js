...
class V1Transactions {
    ...
    __v1ListOrders(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_d = this._options.fetcher) !== null && _d !== void 0 ? _d : core.fetcher)({
                url: core.url.join((_f = (_e = (yield core.Supplier.get(this._options.baseUrl))) !== null && _e !== void 0 ? _e : (yield core.Supplier.get(this._options.environment))) !== null && _f !== void 0 ? _f : environments.SquareEnvironment.Production, `v1/${encodeURIComponent(locationId)}/orders`),
                method: "GET",
                headers: _headers,
    ...
    __v1RetrieveOrder(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_c = this._options.fetcher) !== null && _c !== void 0 ? _c : core.fetcher)({
                url: core.url.join((_e = (_d = (yield core.Supplier.get(this._options.baseUrl))) !== null && _d !== void 0 ? _d : (yield core.Supplier.get(this._options.environment))) !== null && _e !== void 0 ? _e : environments.SquareEnvironment.Production, `v1/${encodeURIComponent(locationId)}/orders/${encodeURIComponent(orderId)}`),
                method: "GET",
                headers: _headers,
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.SquareTimeoutError("Timeout exceeded when calling GET /v1/{location_id}/orders/{order_id}.");
                case "unknown":
                    throw new errors.SquareError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,
     ...
     *     })
     */
    v1UpdateOrder(request, requestOptions) {
        return core.HttpResponsePromise.fromPromise(this.__v1UpdateOrder(request, requestOptions));
    }
    __v1UpdateOrder(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
            const { locationId, orderId } = request, _body = __rest(request, ["locationId", "orderId"]);
            const _headers = (0, headers_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_1.mergeOnlyDefinedHeaders)({
                Authorization: yield this._getAuthorizationHeader(),
                "Square-Version": (_b = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.version) !== null && _b !== void 0 ? _b : "2025-10-16",
            }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.SquareTimeoutError("Timeout exceeded when calling PUT /v1/{location_id}/orders/{order_id}.");
                case "unknown":
                    throw new errors.SquareError({
                        message: _response.error.errorMessage,
                        rawResponse: _response.rawResponse,

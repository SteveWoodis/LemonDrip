...
export declare class TransferOrders {
     ...
     *     })
     */
    create(request: Square.CreateTransferOrderRequest, requestOptions?: TransferOrders.RequestOptions): core.HttpResponsePromise<Square.CreateTransferOrderResponse>;
    private __create;
    /**
     ...
     *     })
     */
    search(request?: Square.SearchTransferOrdersRequest, requestOptions?: TransferOrders.RequestOptions): Promise<core.Page<Square.TransferOrder>>;
    /**
     ...
     *     })
     */
    get(request: Square.GetTransferOrdersRequest, requestOptions?: TransferOrders.RequestOptions): core.HttpResponsePromise<Square.RetrieveTransferOrderResponse>;
    private __get;
    /**
     ...
     *     })
     */
    update(request: Square.UpdateTransferOrderRequest, requestOptions?: TransferOrders.RequestOptions): core.HttpResponsePromise<Square.UpdateTransferOrderResponse>;
    private __update;
    /**
     ...
     *     })
     */
    delete(request: Square.DeleteTransferOrdersRequest, requestOptions?: TransferOrders.RequestOptions): core.HttpResponsePromise<Square.DeleteTransferOrderResponse>;
    private __delete;
    /**
     ...
     *     })
     */
    cancel(request: Square.CancelTransferOrderRequest, requestOptions?: TransferOrders.RequestOptions): core.HttpResponsePromise<Square.CancelTransferOrderResponse>;
    private __cancel;
    /**
     ...
     *     })
     */
    receive(request: Square.ReceiveTransferOrderRequest, requestOptions?: TransferOrders.RequestOptions): core.HttpResponsePromise<Square.ReceiveTransferOrderResponse>;
    private __receive;
    /**
     ...
     *     })
     */
    start(request: Square.StartTransferOrderRequest, requestOptions?: TransferOrders.RequestOptions): core.HttpResponsePromise<Square.StartTransferOrderResponse>;
    private __start;

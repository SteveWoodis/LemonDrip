...
export declare class Rewards {
     ...
     *     })
     */
    create(request: Square.loyalty.CreateLoyaltyRewardRequest, requestOptions?: Rewards.RequestOptions): core.HttpResponsePromise<Square.CreateLoyaltyRewardResponse>;
    private __create;
    /**
     ...
     *     })
     */
    search(request?: Square.loyalty.SearchLoyaltyRewardsRequest, requestOptions?: Rewards.RequestOptions): core.HttpResponsePromise<Square.SearchLoyaltyRewardsResponse>;
    private __search;
    /**
     ...
     *     })
     */
    get(request: Square.loyalty.GetRewardsRequest, requestOptions?: Rewards.RequestOptions): core.HttpResponsePromise<Square.GetLoyaltyRewardResponse>;
    private __get;
    /**
     ...
     *     })
     */
    delete(request: Square.loyalty.DeleteRewardsRequest, requestOptions?: Rewards.RequestOptions): core.HttpResponsePromise<Square.DeleteLoyaltyRewardResponse>;
    private __delete;
    /**
     ...
     *     })
     */
    redeem(request: Square.loyalty.RedeemLoyaltyRewardRequest, requestOptions?: Rewards.RequestOptions): core.HttpResponsePromise<Square.RedeemLoyaltyRewardResponse>;
    private __redeem;

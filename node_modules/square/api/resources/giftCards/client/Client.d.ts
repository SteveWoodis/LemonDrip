...
export declare class GiftCards {
     ...
     *     })
     */
    create(request: Square.CreateGiftCardRequest, requestOptions?: GiftCards.RequestOptions): core.HttpResponsePromise<Square.CreateGiftCardResponse>;
    private __create;
    /**
     ...
     *     })
     */
    getFromGan(request: Square.GetGiftCardFromGanRequest, requestOptions?: GiftCards.RequestOptions): core.HttpResponsePromise<Square.GetGiftCardFromGanResponse>;
     ...
     *     })
     */
    getFromNonce(request: Square.GetGiftCardFromNonceRequest, requestOptions?: GiftCards.RequestOptions): core.HttpResponsePromise<Square.GetGiftCardFromNonceResponse>;
     ...
     *     })
     */
    linkCustomer(request: Square.LinkCustomerToGiftCardRequest, requestOptions?: GiftCards.RequestOptions): core.HttpResponsePromise<Square.LinkCustomerToGiftCardResponse>;
     ...
     *     })
     */
    unlinkCustomer(request: Square.UnlinkCustomerFromGiftCardRequest, requestOptions?: GiftCards.RequestOptions): core.HttpResponsePromise<Square.UnlinkCustomerFromGiftCardResponse>;
     ...
     *     })
     */
    get(request: Square.GetGiftCardsRequest, requestOptions?: GiftCards.RequestOptions): core.HttpResponsePromise<Square.GetGiftCardResponse>;
    private __get;

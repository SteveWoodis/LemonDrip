...
class Labor {
    ...
    get breakTypes() {
        var _a;
        return ((_a = this._breakTypes) !== null && _a !== void 0 ? _a : (this._breakTypes = new Client_1.BreakTypes(this._options)));
    }
    get employeeWages() {
        var _a;
        return ((_a = this._employeeWages) !== null && _a !== void 0 ? _a : (this._employeeWages = new Client_2.EmployeeWages(this._options)));
    }
    get shifts() {
        var _a;
        return ((_a = this._shifts) !== null && _a !== void 0 ? _a : (this._shifts = new Client_3.Shifts(this._options)));
    }
    get teamMemberWages() {
        var _a;
        return ((_a = this._teamMemberWages) !== null && _a !== void 0 ? _a : (this._teamMemberWages = new Client_4.TeamMemberWages(this._options)));
    }
    get workweekConfigs() {
        var _a;
        return ((_a = this._workweekConfigs) !== null && _a !== void 0 ? _a : (this._workweekConfigs = new Client_5.WorkweekConfigs(this._options)));
    }
    /**
    ...
    __retrieveScheduledShift(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_c = this._options.fetcher) !== null && _c !== void 0 ? _c : core.fetcher)({
                url: core.url.join((_e = (_d = (yield core.Supplier.get(this._options.baseUrl))) !== null && _d !== void 0 ? _d : (yield core.Supplier.get(this._options.environment))) !== null && _e !== void 0 ? _e : environments.SquareEnvironment.Production, `v2/labor/scheduled-shifts/${encodeURIComponent(id)}`),
                method: "GET",
                headers: _headers,
                queryParameters: requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams,
                timeoutMs: ((_h = (_f = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) !== null && _f !== void 0 ? _f : (_g = this._options) === null || _g === void 0 ? void 0 : _g.timeoutInSeconds) !== null && _h !== void 0 ? _h : 60) * 1000,
    ...
    __publishScheduledShift(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_c = this._options.fetcher) !== null && _c !== void 0 ? _c : core.fetcher)({
                url: core.url.join((_e = (_d = (yield core.Supplier.get(this._options.baseUrl))) !== null && _d !== void 0 ? _d : (yield core.Supplier.get(this._options.environment))) !== null && _e !== void 0 ? _e : environments.SquareEnvironment.Production, `v2/labor/scheduled-shifts/${encodeURIComponent(id)}/publish`),
                method: "POST",
                headers: _headers,
                contentType: "application/json",
                queryParameters: requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams,
    ...
    __retrieveTimecard(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_c = this._options.fetcher) !== null && _c !== void 0 ? _c : core.fetcher)({
                url: core.url.join((_e = (_d = (yield core.Supplier.get(this._options.baseUrl))) !== null && _d !== void 0 ? _d : (yield core.Supplier.get(this._options.environment))) !== null && _e !== void 0 ? _e : environments.SquareEnvironment.Production, `v2/labor/timecards/${encodeURIComponent(id)}`),
                method: "GET",
                headers: _headers,
                queryParameters: requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams,
                timeoutMs: ((_h = (_f = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) !== null && _f !== void 0 ? _f : (_g = this._options) === null || _g === void 0 ? void 0 : _g.timeoutInSeconds) !== null && _h !== void 0 ? _h : 60) * 1000,

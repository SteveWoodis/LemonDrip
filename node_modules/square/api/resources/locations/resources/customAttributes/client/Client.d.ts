...
export declare class CustomAttributes {
     ...
     *     })
     */
    batchDelete(request: Square.locations.BulkDeleteLocationCustomAttributesRequest, requestOptions?: CustomAttributes.RequestOptions): core.HttpResponsePromise<Square.BulkDeleteLocationCustomAttributesResponse>;
     ...
     *     })
     */
    batchUpsert(request: Square.locations.BulkUpsertLocationCustomAttributesRequest, requestOptions?: CustomAttributes.RequestOptions): core.HttpResponsePromise<Square.BulkUpsertLocationCustomAttributesResponse>;
     ...
     *     })
     */
    list(request: Square.locations.ListCustomAttributesRequest, requestOptions?: CustomAttributes.RequestOptions): Promise<core.Page<Square.CustomAttribute>>;
    /**
     ...
     *     })
     */
    get(request: Square.locations.GetCustomAttributesRequest, requestOptions?: CustomAttributes.RequestOptions): core.HttpResponsePromise<Square.RetrieveLocationCustomAttributeResponse>;
    private __get;
    /**
     ...
     *     })
     */
    upsert(request: Square.locations.UpsertLocationCustomAttributeRequest, requestOptions?: CustomAttributes.RequestOptions): core.HttpResponsePromise<Square.UpsertLocationCustomAttributeResponse>;
    private __upsert;
    /**
     ...
     *     })
     */
    delete(request: Square.locations.DeleteCustomAttributesRequest, requestOptions?: CustomAttributes.RequestOptions): core.HttpResponsePromise<Square.DeleteLocationCustomAttributeResponse>;
    private __delete;

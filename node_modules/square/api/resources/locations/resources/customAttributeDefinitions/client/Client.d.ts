...
export declare class CustomAttributeDefinitions {
     ...
     *     })
     */
    list(request?: Square.locations.ListCustomAttributeDefinitionsRequest, requestOptions?: CustomAttributeDefinitions.RequestOptions): Promise<core.Page<Square.CustomAttributeDefinition>>;
    /**
     ...
     *     })
     */
    create(request: Square.locations.CreateLocationCustomAttributeDefinitionRequest, requestOptions?: CustomAttributeDefinitions.RequestOptions): core.HttpResponsePromise<Square.CreateLocationCustomAttributeDefinitionResponse>;
    private __create;
    /**
     ...
     *     })
     */
    get(request: Square.locations.GetCustomAttributeDefinitionsRequest, requestOptions?: CustomAttributeDefinitions.RequestOptions): core.HttpResponsePromise<Square.RetrieveLocationCustomAttributeDefinitionResponse>;
    private __get;
    /**
     ...
     *     })
     */
    update(request: Square.locations.UpdateLocationCustomAttributeDefinitionRequest, requestOptions?: CustomAttributeDefinitions.RequestOptions): core.HttpResponsePromise<Square.UpdateLocationCustomAttributeDefinitionResponse>;
    private __update;
    /**
     ...
     *     })
     */
    delete(request: Square.locations.DeleteCustomAttributeDefinitionsRequest, requestOptions?: CustomAttributeDefinitions.RequestOptions): core.HttpResponsePromise<Square.DeleteLocationCustomAttributeDefinitionResponse>;
    private __delete;
